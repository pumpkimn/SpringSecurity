package com.lixiang.springsecurity.security.controller;

import com.lixiang.springsecurity.security.domain.JwtUser;
import com.lixiang.springsecurity.security.jwt.JwtAuthenticationException;
import com.lixiang.springsecurity.security.jwt.JwtAuthenticationRequest;
import com.lixiang.springsecurity.security.jwt.JwtAuthenticationResponse;
...
/**
 * @description: 授权控制器 —— 不需要通过JwtAuthenticationTokenFilter鉴权认证
 * @author: lee
